        ...
        <Container style={styles.containter}>
            ...
            >
                ...
                <View style={styles.availabilityContainer}>
                    <View
                        elevation={1}
                        style={[styles.availability, {  flexDirection: 'row', padding: 5,}]}>
                            <Text style={{ paddingLeft: 50, marginRight: 5, fontSize: 16, width: width / 2 - 20}}>Tình trạng:</Text>
                            {availability}
                            <Text style={{  paddingLeft: 10, paddingRight: 5, fontSize: 16, width: width / 2 + 50}}>{availabilityText} </Text> 
                            
                    </View>
                    <View
                        elevation={1}
                        style={{  flexDirection: 'row', padding: 5,}}>
                            <Text style={{ paddingLeft: 50, marginRight: 5, fontSize: 16, width: width / 2 - 20}}>Mô tả:</Text>
                            <Text style={{ paddingRight: 50, fontSize: 16, width: width / 2 + 70}}>{item.description}</Text>
                    </View>                   
                </View>
            </ScrollView>
